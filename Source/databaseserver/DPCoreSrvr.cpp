...
CDPCoreSrvr::CDPCoreSrvr()
{
	...
	ON_MSG( PACKETTYPE_CD_GUILD_LOGO, &CDPCoreSrvr::OnGuildLogo );
	...
	ON_MSG( PACKETTYPE_GUILD_PENYA, &CDPCoreSrvr::OnGuildPenya );
	...
	ON_MSG( PACKETTYPE_ACPT_GUILD_WAR, &CDPCoreSrvr::OnAcptWar );
	ON_MSG( PACKETTYPE_WAR_END, &CDPCoreSrvr::OnWarEnd );
	ON_MSG( PACKETTYPE_SURRENDER, &CDPCoreSrvr::OnSurrender );
	ON_MSG( PACKETTYPE_WAR_DEAD, &CDPCoreSrvr::OnWarDead );
	ON_MSG( PACKETTYPE_WAR_MASTER_ABSENT, &CDPCoreSrvr::OnWarMasterAbsent );
	ON_MSG( PACKETTYPE_CD_ADDVOTE ,			&CDPCoreSrvr::OnAddVote );
	ON_MSG( PACKETTYPE_CD_REMOVEVOTE,		&CDPCoreSrvr::OnRemoveVote );
	ON_MSG( PACKETTYPE_CD_CLOSEVOTE	,		&CDPCoreSrvr::OnCloseVote );
	ON_MSG( PACKETTYPE_CD_CASTVOTE	,		&CDPCoreSrvr::OnCastVote );
	ON_MSG( PACKETTYPE_CT_WANTED	,		&CDPCoreSrvr::OnWanted );
	ON_MSG( PACKETTYPE_SETSNOOPGUILD, &CDPCoreSrvr::OnSnoopGuild );
